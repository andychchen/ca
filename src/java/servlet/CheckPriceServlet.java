...
public class CheckPriceServlet extends HttpServlet {
    ...
    protected Product checkScanedProduct(HttpServletRequest request, PrintWriter out, StringBuffer message) {
        ...
        Product product = productJpaController.findProduct(isbn);
        ...
        request.setAttribute("JspProduct", product);
        return product;
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CheckPriceServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CheckPriceServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
            setupController();
            ...
            RequestDispatcher dispatcher = context.getRequestDispatcher("/product/CheckPrice.jsp");
