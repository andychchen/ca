...
<f:view>
    <html>
        ...
        <body>
            ...
            <h1>New EmpUsers</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{empUsers.validateCreate}" value="value"/>
                <h:panelGrid columns="2">
                    <h:outputText value="Id:"/>
                    <h:inputText id="id" value="#{empUsers.empUsers.id}" title="Id" required="true" requiredMessage="The id field is required." />
                ...
                <br />
                <h:commandLink action="#{empUsers.create}" value="Create"/>
                <br />
                <br />
