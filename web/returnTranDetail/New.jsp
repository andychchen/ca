...
<f:view>
    <html>
        <head>
            ...
            <title>New ReturnTranDetail</title>
        ...
        <body>
            ...
            <h1>New ReturnTranDetail</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{returnTranDetail.validateCreate}" value="value"/>
                ...
                <br />
                <h:commandLink action="#{returnTranDetail.create}" value="Create"/>
                <br />
                <br />
