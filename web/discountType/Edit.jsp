...
<f:view>
    <html>
        <head>
            ...
            <title>Editing DiscountType</title>
        ...
        <body>
            ...
            <h:form>
                ...
                <br />
                <h:commandLink action="#{discountType.edit}" value="Save">
                ...
                <br />
                <br />
                <h:commandLink action="#{discountType.detailSetup}" value="Show" immediate="true">
                    <f:param name="jsfcrud.currentDiscountType" value="#{jsfcrud_class['jsf.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][discountType.discountType][discountType.converter].jsfcrud_invoke}"/>
                </h:commandLink>
                <br />
