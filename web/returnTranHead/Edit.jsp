...
<f:view>
    <html>
        <head>
            ...
            <title>Editing ReturnTranHead</title>
        ...
        <body>
            ...
            <h:form>
                ...
                <br />
                <h:commandLink action="#{returnTranHead.edit}" value="Save">
                ...
                <br />
                <br />
                <h:commandLink action="#{returnTranHead.detailSetup}" value="Show" immediate="true">
                    <f:param name="jsfcrud.currentReturnTranHead" value="#{jsfcrud_class['jsf.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][returnTranHead.returnTranHead][returnTranHead.converter].jsfcrud_invoke}"/>
                </h:commandLink>
                <br />
