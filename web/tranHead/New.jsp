...
<f:view>
    <html>
        ...
        <body>
            ...
            <h1>New TranHead</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{tranHead.validateCreate}" value="value"/>
                ...
                <br />
                <h:commandLink action="#{tranHead.create}" value="Create"/>
                <br />
                <br />
